# core_packages_decision

## Purpose

Mission decision engine, behavior management, mission planning, task scheduling, objective prioritization, and adaptive re-planning.

## Layer

`core_packages/decision`
