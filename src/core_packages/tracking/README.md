# core_packages_tracking

## Purpose

Multi-object tracking, tracklet management, identity persistence, target selection, lock-status monitoring, and trajectory prediction.

## Layer

`core_packages/tracking`
